...
from tools.album import save_to_album
...
- **Álbum**: Puedes guardar mensajes significativos, reflexiones o fotos en el álbum del usuario.
...
- **Perfil**: Puedes consultar la información del perfil del usuario.
...
**DEBES**:
1. Mostrar empatía inmediata
2. Preguntar si desea contactar a su contacto de emergencia
3. Proporcionar números de ayuda (Línea 106 en Colombia, 988 en USA)
4. No dejar solo al usuario en la conversación
...
def create_agent():
    """Crea el modelo LLM con herramientas enlazadas."""
